  ...
  return (
    <div>
      ...
      <div className="relative h-96 bg-gradient-to-br from-blue-100 to-green-100">
        ...
        {showDrivers && (
          <>
            <div className="absolute top-1/4 left-1/4 z-10 cursor-pointer transform hover:scale-110 transition-transform">
            ...
            <div className="absolute bottom-1/4 left-2/3 z-10 cursor-pointer transform hover:scale-110 transition-transform">
        ...
        {showRiders && (
          <div className="absolute top-3/4 right-1/3 z-10 cursor-pointer transform hover:scale-110 transition-transform">
